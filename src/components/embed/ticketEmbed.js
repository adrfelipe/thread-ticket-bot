...
function ticketEmbed(interaction, attendance) {
  return new EmbedBuilder()
    ...
    .setDescription(`<:verify:1044825144658509844> Somente você e a equipe da staff tem acesso à este canal.\n
      ...
      > Todos os <@&997987655209980015> já estão ciente de seu ticket, **__aguarde__** que em breve algum membro de nossa equipe irá iniciar seu atendimento!\n
